...
public class AutoCommands {
    ...
    static Vector2 leftNotePos = new Vector2(-1.55, 2.4);
    static Vector2 middleNotePos = new Vector2(-0.1, 2.4);
    static Vector2 rightNotePos = new Vector2(1, 2.55);

    static Vector2 lmTransPos = new Vector2((leftNotePos.x + middleNotePos.x) / 2, 1.75);
